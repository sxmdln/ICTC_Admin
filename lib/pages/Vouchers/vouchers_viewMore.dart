...
// class VoucherViewMore extends StatefulWidget {
//   final Voucher voucher;
  
//   const VoucherViewMore({required this.voucher, super.key});

//   @override
//   State<VoucherViewMore> createState() => _VoucherViewMoreState();
// }

// class _VoucherViewMoreState extends State<VoucherViewMore> {
//   late final Future<List<Course>> voucherCourses;

//   @override
//   void initState() {
//     voucherCourses = Supabase.instance.client
//         .from('course')
//         .select()
...
//                         Text(widget.voucher.voucherCode,
//                             style: const TextStyle(
//                                 fontSize: 24, fontWeight: FontWeight.w600)),
//                         const SizedBox(height: 20),
//                         Text(
//                           widget.voucher.percentOff as String,
//                           maxLines: 3,
...
//                       voucherCourseCard(courses[index]),
...
//   Widget voucherCourseCard(Course course) {
//     return Container(
